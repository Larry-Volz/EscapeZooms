  ...
  * the more permanent one ??? http://box5859.temp.domains/~richmov8 ???
    ...
    //DONE: test single value posted to here from js and and then inserted into db
     ...
     if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $cat0_row0_q = $_POST["cat0_row0_a"];
        $cat0_row1_q = $_POST["cat0_row1_a"];
        $cat0_row2_q = $_POST["cat0_row2_a"];
        $cat0_row3_q = $_POST["cat0_row3_a"];
        $cat0_row4_q = $_POST["cat0_row4_a"];
        
        $cat1_row0_q = $_POST["cat1_row0_a"];
        $cat1_row1_q = $_POST["cat1_row1_a"];
        $cat1_row2_q = $_POST["cat1_row2_a"];
        $cat1_row3_q = $_POST["cat1_row3_a"];
        $cat1_row4_q = $_POST["cat1_row4_a"];

        $cat2_row0_q = $_POST["cat2_row0_a"];
        $cat2_row1_q = $_POST["cat2_row1_a"];
        $cat2_row2_q = $_POST["cat2_row2_a"];
        $cat2_row3_q = $_POST["cat2_row3_a"];
        $cat2_row4_q = $_POST["cat2_row4_a"];

        $cat3_row0_q = $_POST["cat3_row0_a"];
        $cat3_row1_q = $_POST["cat3_row1_a"];
        $cat3_row2_q = $_POST["cat3_row2_a"];
        $cat3_row3_q = $_POST["cat3_row3_a"];
        $cat3_row4_q = $_POST["cat3_row4_a"];

        $cat4_row0_q = $_POST["cat4_row0_a"];
        $cat4_row1_q = $_POST["cat4_row1_a"];
        $cat4_row2_q = $_POST["cat4_row2_a"];
        $cat4_row3_q = $_POST["cat4_row3_a"];
        $cat4_row4_q = $_POST["cat4_row4_a"];
       
        $cat5_row0_q = $_POST["cat5_row0_a"];
        $cat5_row1_q = $_POST["cat5_row1_a"];
        $cat5_row2_q = $_POST["cat5_row2_a"];
        $cat5_row3_q = $_POST["cat5_row3_a"];
        $cat5_row4_q = $_POST["cat5_row4_a"];

        $link = connect_to_server();

        
        $sql = "INSERT INTO game_marker_jeopardy (cat0, cat1, cat2, cat3, cat4, cat5, cat0_row0_q, cat0_row1_q, cat0_row2_q, cat0_row3_q, cat0_row4_q, cat1_row0_q, cat1_row1_q, cat1_row2_q, cat1_row3_q, cat1_row4_q, cat2_row0_q, cat2_row1_q, cat2_row2_q, cat2_row3_q, cat2_row4_q, cat3_row0_q, cat3_row1_q, cat3_row2_q, cat3_row3_q, cat3_row4_q, cat4_row0_q, cat4_row1_q, cat4_row2_q, cat4_row3_q, cat4_row4_q, cat5_row0_q, cat5_row1_q, cat5_row2_q, cat5_row3_q, cat5_row4_q, cat0_row0_a, cat0_row1_a, cat0_row2_a, cat0_row3_a, cat0_row4_a, cat1_row0_a, cat1_row1_a, cat1_row2_a, cat1_row3_a, cat1_row4_a, cat2_row0_a, cat2_row1_a, cat2_row2_a, cat2_row3_a, cat2_row4_a, cat3_row0_a, cat3_row1_a, cat3_row2_a, cat3_row3_a, cat3_row4_a, cat4_row0_a, cat4_row1_a, cat4_row2_a, cat4_row3_a, cat4_row4_a, cat5_row0_a, cat5_row1_a, cat5_row2_a, cat5_row3_a, cat5_row4_a) VALUES ('$cat0','$cat1','$cat2','$cat3','$cat4','$cat5','$cat0_row0_q', '$cat0_row1_q', '$cat0_row2_q', '$cat0_row3_q', '$cat0_row4_q','$cat1_row0_q', '$cat1_row1_q', '$cat1_row2_q', '$cat1_row3_q', '$cat1_row4_q','$cat2_row0_q', '$cat2_row1_q', '$cat2_row2_q', '$cat2_row3_q', '$cat2_row4_q', '$cat3_row0_q', '$cat3_row1_q', '$cat3_row2_q', '$cat3_row3_q', '$cat3_row4_q', '$cat4_row0_q', '$cat4_row1_q', '$cat4_row2_q', '$cat4_row3_q', '$cat4_row4_q', '$cat5_row0_q', '$cat5_row1_q', '$cat5_row2_q', '$cat5_row3_q', '$cat5_row4_q','$cat0_row0_a', '$cat0_row1_a', '$cat0_row2_a', '$cat0_row3_a', '$cat0_row4_a','$cat1_row0_a', '$cat1_row1_a', '$cat1_row2_a', '$cat1_row3_a', '$cat1_row4_a','$cat2_row0_a', '$cat2_row1_a', '$cat2_row2_a', '$cat2_row3_a', '$cat2_row4_a', '$cat3_row0_a', '$cat3_row1_a', '$cat3_row2_a', '$cat3_row3_a', '$cat3_row4_a', '$cat4_row0_a', '$cat4_row1_a', '$cat4_row2_a', '$cat4_row3_a', '$cat4_row4_a', '$cat5_row0_a', '$cat5_row1_a', '$cat5_row2_a', '$cat5_row3_a', '$cat5_row4_a')";
