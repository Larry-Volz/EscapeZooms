...
function insertSql(categories) {
    ...
    $.post(
        ...
        cat5_row0_q : sqlStringCleaner(categories[catArr[5]][0].answer),
        cat5_row1_q : sqlStringCleaner(categories[catArr[5]][1].answer),
        cat5_row2_q : sqlStringCleaner(categories[catArr[5]][2].answer),
        cat5_row3_q : sqlStringCleaner(categories[catArr[5]][3].answer),
        cat5_row4_q : sqlStringCleaner(categories[catArr[5]][4].answer),

        cat0_row0_q : sqlStringCleaner(categories[catArr[0]][0].answer),
        cat0_row1_q : sqlStringCleaner(categories[catArr[0]][1].answer),
        cat0_row2_q : sqlStringCleaner(categories[catArr[0]][2].answer),
        cat0_row3_q : sqlStringCleaner(categories[catArr[0]][3].answer),
        cat0_row4_q : sqlStringCleaner(categories[catArr[0]][4].answer),

        cat1_row0_q : sqlStringCleaner(categories[catArr[1]][0].answer),
        cat1_row1_q : sqlStringCleaner(categories[catArr[1]][1].answer),
        cat1_row2_q : sqlStringCleaner(categories[catArr[1]][2].answer),
        cat1_row3_q : sqlStringCleaner(categories[catArr[1]][3].answer),
        cat1_row4_q : sqlStringCleaner(categories[catArr[1]][4].answer),

        cat2_row0_q : sqlStringCleaner(categories[catArr[2]][0].answer),
        cat2_row1_q : sqlStringCleaner(categories[catArr[2]][1].answer),
        cat2_row2_q : sqlStringCleaner(categories[catArr[2]][2].answer),
        cat2_row3_q : sqlStringCleaner(categories[catArr[2]][3].answer),
        cat2_row4_q : sqlStringCleaner(categories[catArr[2]][4].answer),

        cat3_row0_q : sqlStringCleaner(categories[catArr[3]][0].answer),
        cat3_row1_q : sqlStringCleaner(categories[catArr[3]][1].answer),
        cat3_row2_q : sqlStringCleaner(categories[catArr[3]][2].answer),
        cat3_row3_q : sqlStringCleaner(categories[catArr[3]][3].answer),
        cat3_row4_q : sqlStringCleaner(categories[catArr[3]][4].answer),

        cat4_row0_q : sqlStringCleaner(categories[catArr[4]][0].answer),
        cat4_row1_q : sqlStringCleaner(categories[catArr[4]][1].answer),
        cat4_row2_q : sqlStringCleaner(categories[catArr[4]][2].answer),
        cat4_row3_q : sqlStringCleaner(categories[catArr[4]][3].answer),
        cat4_row4_q : sqlStringCleaner(categories[catArr[4]][4].answer),
    ...
    //CHECK categories STRUCTURE AND ACCESS
    // for (let j = 0; j <5; j++) {
    //     $.post('sql_initial_insert.php',)
    //     console.log(`categories[catArr[0]][${j}].question: ${categories[catArr[0]][j].question}`)
    // }


    // let tempStr = "cat0_row0_q";
    // $.post('sql_initial_insert.php', {'tempStr' : categories[catArr[0]][0].question})
